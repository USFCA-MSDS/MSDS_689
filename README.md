...
Lecture 5 :  Dijkstra algorithm, More on graphs in data science.
   ...
   * Application : [graph k-means notebook](https://github.com/USFCA-MSDS/MSDS_689/blob/main/notebooks/graphkmeans.ipynb)
   * Application : [graph k-means slides](https://github.com/USFCA-MSDS/MSDS_689/blob/main/lectures/pagerank_and_kmean_clustering_.pdf)
